        ...
        add_filter('fluentform/disabled_components', function ($disables) {
            ...
            if(!$isEnabled) {
                ...
                $disables['payment_coupon'] = [
                    'disabled' => true,
                    'disable_html' => '<div class="text-align-center"><h4 class="mb-5">Please Activate Coupon Module First</h4><a target="_blank" class="el-button el-button--primary" href="'.$couponUrl.'">Activate Coupon Module</a><p class="mt-3">After creating your first coupon please reload this page.</p></div>'
                ];
            }

    ...
    public function getPayments()
    {
        ...
        foreach ($payments as $payment) {
            ...
            $status = apply_filters_deprecated(
                'ff_payment_entries_human_date',
                [
                    true
                ],
                FLUENTFORM_FRAMEWORK_UPGRADE,
                'fluentform/payment_entries_human_date',
                'Use fluentform/payment_entries_human_date instead of ff_payment_entries_human_date.'
            );

            if(apply_filters('fluentform/payment_entries_human_date', $status)){

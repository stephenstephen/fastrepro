...
class Bootstrap extends IntegrationManager
{
    public function __construct(Application $app)
    {
        ...
        $this->description = 'Create signup forms in WordPress and connect ActiveCampaign to grow your list easily.';
        ...
        return [
            'fields' => [
                ...
                [
                    ...
                    'require_list' => true,
                    'label' => 'Map Fields',
                    'tips' => 'Select which Fluent Forms fields pair with their<br /> respective ActiveCampaign fields.',
    ...
    public function notify($feed, $formData, $entry, $form)
    {
        ...
        if (!is_email($feedData['fieldEmailAddress'])) {
            do_action('fluentform/integration_action_result', $feed, 'failed', 'Active Campaign API call has been skipped because no valid email available');
            return;
        }
        ...
        if (is_wp_error($response)) {
            ...
            do_action('fluentform/integration_action_result', $feed, 'success', 'Active Campaign has been successfully initialed and pushed data');

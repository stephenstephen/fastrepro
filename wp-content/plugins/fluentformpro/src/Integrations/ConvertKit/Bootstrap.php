...
class Bootstrap extends IntegrationManager
{
        ...
        return [
            'fields'              => [
                ...
                [
                    ...
                    'require_list'       => true,
                    'label'              => 'Map Fields',
                    'tips'               => 'Select which Fluent Forms fields pair with their<br /> respective ConvertKit fields.',
    ...
    public function notify($feed, $formData, $entry, $form)
    {
        ...
        if(!is_email($feedData['email'])) {
            do_action('fluentform/integration_action_result', $feed, 'failed', 'ConvertKit API call has been skipped because no valid email available');
            return;
        }
        ...
        if(is_wp_error($response)) {
            ...
            do_action('fluentform/integration_action_result', $feed, 'success', 'ConvertKit feed has been successfully initialed and pushed data');
        }
    }

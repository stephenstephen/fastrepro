...
class Bootstrap extends IntegrationManager
{
        ...
        return [
            'fields'              => [
                ...
                [
                    ...
                    'require_list'       => true,
                    'label'              => 'Map Fields',
                    'tips'               => 'Associate your SendFox merge tags to the appropriate Fluent Forms fields by selecting the appropriate form field from the list.',
    ...
    public function notify($feed, $formData, $entry, $form)
    {
        ...
        if (!is_email($feedData['Email'])) {
            do_action('fluentform/integration_action_result', $feed, 'failed', 'SendFox API call has been skipped because no valid email available');
            return;
        }
        ...
        if (!$result) {
            do_action('fluentform/integration_action_result', $feed, 'failed', 'SendFox API call has been failed');
        } else {
            do_action('fluentform/integration_action_result', $feed, 'success', 'SendFox feed has been successfully initialed and pushed data');
        }
    }

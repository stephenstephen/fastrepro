...
//        add_filter('fluentform/notifying_async_mailerlite', '__return_false');
        ...
        return [
            'fields'              => [
                ...
                [
                    ...
                    'require_list'       => true,
                    'label'              => 'Map Fields',
                    'tips'               => 'Select which Fluent Forms fields pair with their<br /> respective MailerLite fields.',
                ...
                [
                    ...
                    'key'            => 'resubscribe',
                    'label'          => 'Resubscribe',
                    'checkbox_label' => 'Reactivate subscriber if value is checked',
    ...
    public function notify($feed, $formData, $entry, $form)
    {
        ...
        if (empty($subscriber['email']) || !is_email($subscriber['email'])) {
            do_action('fluentform/integration_action_result', $feed, 'failed', 'MailerLte API call has been skipped because no valid email available');
            return;
        }
        ...
        do_action('fluentform/integration_action_result', $feed, 'success', 'MailerLite feed has been successfully initialed and pushed data');
    }

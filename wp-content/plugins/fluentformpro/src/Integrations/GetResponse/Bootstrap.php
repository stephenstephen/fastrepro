...
//        add_filter('fluentform/notifying_async_getresponse', '__return_false');
        ...
        return [
            'fields'              => [
                ...
                [
                    ...
                    'require_list'       => true,
                    'label'              => 'Map Fields',
                    'tips'               => 'Select which Fluent Forms fields pair with their<br /> respective GetResponse fields.',
    ...
    public function notify($feed, $formData, $entry, $form)
    {
        ...
        if (!is_email($feedData['fieldEmailAddress'])) {
            do_action('fluentform/integration_action_result', $feed, 'failed', 'GetResponse API call has been skipped because no valid email available');
        }
       ...
       if($response->httpStatus === 400) {
           ...
           do_action('fluentform/integration_action_result', $feed, 'success', 'GetResponse feed has been successfully initialed and pushed data');
       }

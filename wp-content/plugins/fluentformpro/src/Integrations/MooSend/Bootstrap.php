...
//        add_filter('fluentform/notifying_async_moosend', '__return_false');
        ...
        return [
            'fields'              => [
                ...
                [
                    ...
                    'require_list'       => true,
                    'label'              => 'Map Fields',
                    'tips'               => 'Associate your MooSend merge tags to the appropriate Fluent Forms fields by selecting the appropriate form field from the list.',
    ...
    public function notify($feed, $formData, $entry, $form)
    {
        ...
        if (!is_email($feedData['Email'])) {
            do_action('fluentform/integration_action_result', $feed, 'failed', 'Moosend API call has been skipped because no valid email available');
        ...
        do_action('fluentform/integration_action_result', $feed, 'success', 'Moosend feed has been successfully initialed and pushed data');

...
class Bootstrap extends IntegrationManager
{
    ...
    public function notify($feed, $formData, $entry, $form)
    {
        ...
        if (!$metaFields) {
            do_action('fluentform/integration_action_result', $feed, 'failed', 'No meta fields found');
        }
        ...
        if (is_wp_error($response)) {
            ...
            do_action('fluentform/integration_action_result', $feed, 'success', 'Pushed data to Google Sheet');
        }
    }
}

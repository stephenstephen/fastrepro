...
//
        foreach ($results as $name => $result) {
            ...
            $maybeNoRightWrongAns = in_array($scoreType, ['total_point', 'personality']) ? '' : "<div style='width: 20px; margin-right: 10px;'>$icon</div>";
    
            $html .= "<tr class=\"field-label\">
                        <td style=\"display: flex; align-items: center; padding: 6px 12px; background-color: #f8f8f8; text-align: left;\">
                            {$maybeNoRightWrongAns} <div><b>{$result['label']}</b></div>
                        </td>
                    </tr>";

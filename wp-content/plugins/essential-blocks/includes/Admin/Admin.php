...
class Admin {
    ...
    public function notices() {
         ...
         */
        $notice_body = "<div class='pro_launching_campaign_body'>
                <p class='pro_launching_campaign_content'>Early Birds Specials: Grab <strong>LIFETIME</strong> Access To <strong>Premium Gutenberg Blocks</strong></p>
            </div>";
        $pro_launching_campaign = [
            ...
            'links'     => [
                'upgrade_pro'      => [
                    'link'       => 'https://essential-blocks.com/pricing',
                    'label'      => __( 'Upgrade to Pro Now', 'essential-blocks' ),
                    'attributes' => [
                        'target'       => '_blank',
                ...
                'lifetime'         => [
                    'link'       => 'https://essential-blocks.com/pricing/?package=lifetime',
                    'label'      => __( 'Give Me LIFETIME Access', 'essential-blocks' ),
                    'attributes' => [
                        'target'       => '_blank',
                ...
                'never_show_again' => [
                    'label'      => __( 'I Don\'t Want To Save Money', 'essential-blocks' ),
                    'attributes' => [
